...
variable "vpc_cidr_east_private" {
    description = "CIDR for the private subnet in East VPC"
}
variable "vpc_cidr_east_public" {
    description = "CIDR for the public subnet in East VPC"
}
variable "vpc_cidr_west" {
    description = "CIDR for the whole west VPC"
}
variable "vpc_cidr_west_private" {
    description = "CIDR for the private subnet in west VPC"
}
variable "vpc_cidr_west_public" {
    description = "CIDR for the public subnet in west VPC"
}
